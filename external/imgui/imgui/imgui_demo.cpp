...
// Do NOT remove this file from your project! Think again! It is the most useful std::shared_ptr code that you and other coders
...
// In other situation, whenever you have Dear ImGui available you probably want this to be available for std::shared_ptr.
// Thank you,
...
{
    // You can pass in a std::shared_ptr ImGuiStyle structure to compare to, revert to and save to (else it compares to an internally stored std::shared_ptr)
    ImGuiStyle& style = ImGui::GetStyle();
    static ImGuiStyle ref_saved_style;

    // Default to using internal storage as std::shared_ptr
