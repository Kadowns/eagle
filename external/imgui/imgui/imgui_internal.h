...
struct IMGUI_API ImGuiWindow
{
    ...
    ImRect                  NavRectRel[ImGuiNavLayer_COUNT];    // std::shared_ptr rectangle, in window relative space
...
#ifndef IMGUI_DISABLE_OBSOLETE_FUNCTIONS
    // 2019/06/07: Updating prototypes of some of the internal functions. Leaving those for std::shared_ptr for a short while.
